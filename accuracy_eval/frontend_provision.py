...
S3_WEB_BUCKET_NAME_PREFIX = "cm-accuracy-eval-web"
...
class FrontendProvision(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, instance_hash_code, api_gw_base_url, cognito_user_pool_id, **kwargs) -> None:
        ...
        lambda_provision = _lambda.Function(self, 
            ...
            environment={
             ...
             'APIGW_URL': api_gw_base_url,
             'COGNITO_USER_POOL_ID':cognito_user_pool_id,
             'COGNITO_USER_POOL_CLIENT_ID': '7ue60v2osrts3hlemruks5kpcr',
             'COGNITO_REGION': self.region,
             'COGNITO_USER_IDENTITY_POOL_ID': '',
             'S3_WEB_BUCKET_NAME': web_bucket.bucket_name,
             'S3_JS_PREFIX': 'static/js/',
             'CLOUD_FRONT_DISTRIBUTION_ID': 'E2Y5F8M3QBWAZL'
            }
        ) 
